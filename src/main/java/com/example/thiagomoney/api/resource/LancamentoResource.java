...
import com.example.thiagomoney.api.exceptionhandler.ThiagomoneyExceptionHandler.Erro;
...
import com.example.thiagomoney.api.service.LancamentoService;
...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo) {
		Lancamento lancamento = lancamentoRepository.find(codigo);
